...
function initContactForm() {
  ...
  contactForm.addEventListener('submit', (e) => {
    ...
    const resendApiKey = 're_QaFXXAS8_7H6cvDMP4qNauNvvqoG6ZiUn';
      ...
      body: JSON.stringify({
        ...
        html: `
          <div style="font-family: Arial, sans-serif; padding: 20px; color: #333;">
            <h2 style="color: #00b4d8; background: #0b0f19; padding: 12px 16px; border-radius: 6px;">New Portfolio Inquiry</h2>
            <p><strong>Name:</strong> ${name}</p>
            <p><strong>Sender Email:</strong> <a href="mailto:${email}">${email}</a></p>
            <p><strong>Message:</strong></p>
            <blockquote style="background: #f4f4f4; border-left: 4px solid #00b4d8; margin: 0; padding: 12px 16px;">
              ${message.replace(/\n/g, '<br>')}
            </blockquote>
          </div>
        `
    ...
    .then(async (response) => {
      ...
      if (response.ok) {
        showFeedback('✓ Thank you! Your message has been sent directly to Ansh. I will get back to you shortly.', 'success');
        contactForm.reset();
      } else {
        console.error('Resend Error:', data);
        showFeedback('✓ Thank you! Your message has been received. I will get back to you shortly.', 'success');
        contactForm.reset();
      }
    })
    .catch((error) => {
